...
from modules.open_digraph_composition import *
import inspect

from modules.open_digraph_composition import open_digraph_composition
...
o0 = node(5, 'o0', {1:1}, {})
o1 = node(6, 'o1', {2:1}, {})
G = open_digraph_composition([3,4], [5,6], [n0,n1,n2,i0,i1,o0,o1])

n3 = node(0, 'x', {}, {1:1,2:1})
n4 = node(1, 'y', {0:1}, {2:1})
n5 = node(2, 'z', {0:1,1:1}, {0:1})

opd = open_digraph_composition([0],[2],[n3,n4,n5])
